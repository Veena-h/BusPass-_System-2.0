...
<table class="table" border="1px solid black">
  ...
  try{
      ...
      bus_model b=new bus_model(connection.getconnection());
       List<BusAdd_entity> al=b.showbystopname(stopno);
       for(BusAdd_entity s:al)
       {
    	       ...
    	       List<BusAdd_entity> al1=b.showByMainbusNo(stopno);
   ...
   %>                                     
    ...
    <tr>
     ...
     <td><%=s.getDriver_name() %></td>
      ...
      <td > <a href="route_form.jsp?stopid=<%=s.getId()	%>&id=<%=id %>&MainbusNo=<%=s11.getMainBusNo() %>" class="btn btn-dark rounded-pill "> Form</a></td> 
